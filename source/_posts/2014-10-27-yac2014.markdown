...
#### Секретный доклад <mark style="background: #666; color: #fff">General</mark>
...
#### Использование Python для интерактивного анализа данных <mark style="background: #ffb545; color: #fff">Backend</mark>####
...
<footer><strong>Николай Колдунов</strong>, <cite>Climate Service Center</cite>
...
#### State of the Standardized Web <mark style="background: #00b3e3; color: #fff">Frontend</mark>####
...
<footer><strong>Сергей Константинов</strong>, <cite>Яндекс</cite>
...
#### Проектировка IPv6-оnly датацентра в Яндексе <mark style="background: #cb299a; color: #fff">Administration</mark>####
...
<footer><strong>Никита Широков</strong>, <cite>Яндекс</cite>
...
#### Масштабируемая конфигурация nginx <mark style="background: #ffb545; color: #fff">Backend</mark> <mark style="background: #cb299a; color: #fff">Administration</mark>####
...
<footer><strong>Игорь Сысоев</strong>, <cite>Nginx Inc.</cite>
<p>Технический директор Nginx Inc., наше всё.</p>
</footer></blockquote>


#### Netflix CDN и открытый код <mark style="background: #cb299a; color: #fff">Administration</mark>####
...
<footer><strong>Глеб Смирнов</strong>, <cite>Nginx Inc.</cite>
...
#### Как мы делали TLS в Яндексе <mark style="background: #00a885; color: #fff">Information Security</mark>####
...
<footer><strong>Эльдар Заитов</strong>, <cite>Яндекс</cite>
...
#### Building a Modern Security Engineering Organization <mark style="background: #00a885; color: #fff">Information Security</mark>####
...
<footer><strong>Zane Lackey</strong>, <cite>Signal Sciences</cite>
...
#### Развёртывание отказоустойчивой инфраструктуры OpenStack <mark style="background: #cb299a; color: #fff">Administration</mark>####
...
<footer><strong>Владимир Ерёмин</strong>, <cite>Яндекс</cite>
...
#### Logbroker: сбор и поставка больших объёмов данных <mark style="background: #ffb545; color: #fff">Backend</mark>####
...
<footer><strong>Алексей Озерицкий</strong>, <cite>Яндекс</cite>
...
#### Crash Test Your Application... And Your Team <mark style="background: #ffb545; color: #fff">Backend</mark> <mark style="background: #cb299a; color: #fff">Administration</mark>####
...
<footer><strong>Carlos Conde</strong>, <cite>Amazon</cite>
...
#### Секретный доклад по безопасности <mark style="background: #00a885; color: #fff">Information Security</mark>
